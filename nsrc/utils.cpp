...
Pos2D City::getPos() const { return pos_city; }

double City::distanceTo(const City& other) const {
    return pos_city.distanceTo(other.pos_city);
}

double City::distanceTo(const Village& other) const {
    return pos_city.distanceTo(other.getPos());
}
...
Pos2D Village::getPos() const { return pos_village; }

double Village::distanceTo(const Village& other) const {
    return pos_village.distanceTo(other.pos_village);
}

double Village::distanceTo(const City& other) const {
    return pos_village.distanceTo(other.getPos());
}
...
double Copter::getFixedCost() const { return fixed_cost; }
double Copter::getVariableCost() const { return variable_cost; }
